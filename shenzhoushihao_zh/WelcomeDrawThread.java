...
/*
 * 此类属于典型的DrawThread类，与本游戏中的TouchDrawThread和PassDrawThread类完全一样，实现的功能也是开启一个线程后，通过
 *调用doDraw方法不断重回整个屏幕，由于牵涉到不同的View，线程的启动和停止，为了方便编程，所以这才没把三个合并
 *
 */

public class WelcomeDrawThread extends Thread                                  //继承Thread
{
	@SuppressWarnings("unchecked")
	WelcomeView father;                                                        //WelcomeView对象引用
	...
	public WelcomeDrawThread(WelcomeView father,SurfaceHolder surfaceHolder)   //构造方法
	{                
