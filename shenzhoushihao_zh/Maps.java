...
public class Maps 
{
	...
	public static ArrayList<Life> getFirstLife()  //为第一关添加补血道具
	{
	...
	public static ArrayList<ChangeBullet> getFirstBollet()//为第一关添加换枪道具
	{
	...
	public static ArrayList<EnemyPlane> getFirst() //出发点、目标点、当前段上的第几步、路径数组、状态、触发时间、类型、生命
	{
